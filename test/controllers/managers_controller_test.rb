...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference("Manager.count") do
      post managers_url, params: { manager: { admin_id: @manager.admin_id, email: @manager.email, first_name: @manager.first_name, last_name: @manager.last_name, username: @manager.username } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { admin_id: @manager.admin_id, email: @manager.email, first_name: @manager.first_name, last_name: @manager.last_name, username: @manager.username } }
